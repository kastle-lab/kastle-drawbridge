...
- 💡 <ins>_Formal Definition:_</ins> **Competency Questions (CQs)** are questions formatted in natural language that aid in defining the scope and requirements in knowledge representation.

- 💡<ins>_Simplified Definition:_</ins> **CQs** are questions that the ontology engineer(s) create during the ontology development process to keep things organized and ensure the ontology is equipped with all of the information it needs.
...
1.  **Scoping **CQs\*\*\*\* 🔬: Defining the boundaries/Scope of the ontology.
    ...
    - We use **CQs** to help us define the boundaries of the ontology- what should be included or excluded.
...
4.  **Relationship CQ's** 👫: Focus on the connections between different entities.
    ...
    - **RCQ's** check the relationship between entities are modeled properly.

             Example:
                - RCQ: Is a dog 🐕 a type of mammal❓
                - Explanation: we are testing the Is-a relationship and seeing if it is correctly represented.

5.  **Metaproperty CQs** 🟦: Deal with properties of the ontology itself.
