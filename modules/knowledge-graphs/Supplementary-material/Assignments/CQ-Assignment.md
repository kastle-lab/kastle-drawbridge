...
- <ins>**Part 1:**</ins>
  ...
  3.  For each question, briefly explain:
      - **_Why_** it fits the category.
      - **_What_** part of the ontology it would help build or test.

- <ins>**Part 2**</ins>

  In a <ins>_few sentences_</ins> answer the following questions **in your own words**:
...
- you can use the ✨ **_kastle-drawbridge_** ✨slack channel to schedule a time!
